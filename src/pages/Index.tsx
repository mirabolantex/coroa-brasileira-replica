...
const testimonials = [
  {
    ...
    quote: 'Conheci uma mulher incrível aqui! Ela tem 45 anos e nos conectamos instantaneamente. Estamos juntos há 6 meses. Obrigado Minha Coroa!'
  },
  {
    name: 'Sandra M.',
    age: 42,
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="lg:w-1/2">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Encontre Sua Coroa Brasileira Ideal</h1>
              <p className="text-xl mb-8">
                O melhor site de relacionamento para mulheres maduras e homens que as admiram. Conecte-se com pessoas incríveis em busca de relacionamentos verdadeiros.
              </p>
            ...
            <div className="lg:w-1/2 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <Input type="email" id="email" placeholder="seu.email@exemplo.com" className="w-full" />
                </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Por Que Escolher <span className="gradient-text">Minha Coroa</span></h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Encontrar sua coroa ou seu admirador ideal é simples e rápido com apenas três passos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">Encontre Matches</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">Comece a Conversar</h3>
              <p className="text-gray-600 dark:text-gray-400">
              ...
              <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">{testimonial.age} anos</p>
                  </div>
                </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Desbloqueie Todos os Recursos</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              ...
              <div>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span>Veja quem curtiu seu perfil</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-coroa-purple mr-2 mt-0.5 flex-shrink-0" />
      ...
      <section className="bg-gradient-to-r from-coroa-purple to-coroa-pink py-20 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Pronto Para Conhecer Sua Coroa?</h2>
